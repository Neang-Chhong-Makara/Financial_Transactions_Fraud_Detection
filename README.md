...
### 🛠 Step-by-Step Deployment Guide on WSL
...
👉 Since our repo is already structured for Docker, the main effort is just **building and running the container inside WSL**.  
